...
6. When you're done, commit and push all the files associated with the assignment (.RMD file, .HTML knit file, original dataset, your written .csv file) to GitHub. Go to GitHub.com to ensure everything is visible there. If you want me to double check that I can see it, send me an email. 
