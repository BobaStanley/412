...
\begin{figure}
\includegraphics[width=0.5\linewidth]{ICMA_papaja_files/figure-latex/unnamed-chunk-5-1} \caption{Each Chick's weight in grams (y-axis) over time (x-axis), with each chick a separate line}\label{fig:unnamed-chunk-5}
\end{figure}
