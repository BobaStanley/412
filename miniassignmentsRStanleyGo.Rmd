...
```{r}
frac_propcorr_post %>%
  mutate(Condition = factor(Condition, levels = c("Map", "Div", "Cont")),
         Condition = fct_recode(Condition, "Actively Divided Condition" = "Map", "Statistically Divided" = "Div", "Not Divided" = "Cont")) %>%
```
